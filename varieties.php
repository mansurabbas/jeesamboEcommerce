    ...
    <div class="bodyWrapper">
            ...
            <div class="panel list">
                <span>
                    ...
                    <ul>
                        ...
                        ?>
                        <li><div class="checkbox"><label><input type="checkbox" value="<?php echo $product->cleanString($category['categories_id']); ?>" <?php echo @$categoryCheck; ?> name="category[]" class="sort_rang brand"><?php echo ucfirst($category['categories']); ?></label></div></li>
                        <?php } ?>
                    </ul>
        ...
        <div class="mainContainer">
            <div class="innerWrapper">
                    ...
                    <!-- title -->
                    <!-- product card -->
                        <div class="product_category_container" id="results">
